...
\title{Health-Inequality}

\runninghead{Frei \emph{et al}.}

\author{R. Frei*\affilnum{1,2}, O. Tro\affilnum{2}, O.
Vriga\affilnum{3}}
...
\begin{figure}
\includegraphics[width=1\linewidth]{Descriptive-Report_files/figure-latex/plot-ref-1} \caption{Fancy Caption\label{fig:plot}}\label{fig:plot-ref}
\end{figure}
